...
final class PassCodes extends BaseEndpoint implements AuthenticationChannel
{
    /**
     * @var array|string[]
     */
    ...
    {
        return $this->post('passcode/' . $this->channel . '/send', $payload);
    }
    ...
    {
        return $this->post('passcode/' . $this->channel . '/authenticate', $payload);
    }
}
